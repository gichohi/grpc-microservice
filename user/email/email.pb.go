...
var file_email_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x63, 0x0a, 0x05, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x12, 0x0a,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x32, 0x32, 0x0a, 0x0c, 0x45, 0x6d, 0x61,
	0x69, 0x6c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x22, 0x0a, 0x04, 0x53, 0x65, 0x6e,
	0x64, 0x12, 0x0c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x1a,
	0x0c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x42, 0x17, 0x5a,
	0x15, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x69, 0x63, 0x72,
...
var file_email_proto_depIdxs = []int32{
	0, // 0: proto.EmailService.Send:input_type -> proto.Email
	0, // 1: proto.EmailService.Send:output_type -> proto.Email
...
type EmailServiceClient interface {
	Send(ctx context.Context, in *Email, opts ...grpc.CallOption) (*Email, error)
}
...
func (c *emailServiceClient) Send(ctx context.Context, in *Email, opts ...grpc.CallOption) (*Email, error) {
	out := new(Email)
	err := c.cc.Invoke(ctx, "/proto.EmailService/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmailServiceServer interface {
	Send(context.Context, *Email) (*Email, error)
}
...
func (*UnimplementedEmailServiceServer) Send(context.Context, *Email) (*Email, error) {
...
func _EmailService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.EmailService/Send",
	}
